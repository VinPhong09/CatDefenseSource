...
public class DetailsHeroManagement : MonoBehaviour
{
    ...
    [SerializeField]protected CatBoxerProperties _CatBoxerPro;
    ...
    [SerializeField] protected CatFoloProperties _CatFoloPro;
    ...
    [SerializeField]protected CatMuradProperties _CatMuradPro;
    ...
    [SerializeField] protected CatVampireProperties _CatVampirePro;
    ...
    void Start()
    {
        ...
        _CatBoxerPro = _CatBoxer.GetComponent<CatBoxerProperties>();
...
#region CaboxerScripts
    ...
    {
        _BoxerHptext.text = "Máu: " + _CatBoxerPro.GetTextHealth();
    ...
    {
        _CatBoxerPro.SetRateDMGskill1();
        _BoxerLevelSkill1++;
    }

    public void BoxerUpgrageSkill2()
    {
        _CatBoxerPro.SetRateDMGskill2();
        _BoxerLevelSkill2++;
    }
    
    public void BoxerUpgrageSkill()
    {
        _CatBoxerPro.SetRateDMGskill();
        _BoxerLevelSkill++;
    }

    public void BoxerUpLevel()
    {
        _CatBoxerPro.UpLevel();
    }
